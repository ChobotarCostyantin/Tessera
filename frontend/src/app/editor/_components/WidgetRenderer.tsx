    ...
    switch (widget.type) {
            ...
            return (
                <div className="flex flex-col h-full justify-center gap-2 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                        <h3 className="text-xl font-semibold leading-tight tracking-tight truncate"
                            style={{ color: 'var(--t-text)' }}>{widget.name}</h3>
                        <p className="text-sm mt-0.5 truncate" style={{ color: 'var(--t-muted)' }}>{widget.role}</p>
                        {widget.bio && (
                            <p className="text-xs mt-2 leading-relaxed line-clamp-3"
                               style={{ color: 'var(--t-muted)' }}>{widget.bio}</p>
                        )}
                    </div>
                </div>
            );
        ...
        case 'skills':
            return (
                <div className="h-full flex flex-col overflow-hidden">
                    <p className="text-[10px] font-semibold uppercase tracking-widest mb-2 shrink-0"
                       style={{ color: 'var(--t-muted)' }}>Skills</p>
        ...
        case 'experience':
            return (
                <div className="h-full flex flex-col overflow-hidden">
                    <p className="text-[10px] font-semibold uppercase tracking-widest mb-2 shrink-0"
                       style={{ color: 'var(--t-muted)' }}>Experience</p>
        ...
        case 'links':
            return (
                <div className="h-full flex flex-col overflow-hidden">
                    <p className="text-[10px] font-semibold uppercase tracking-widest mb-2 shrink-0"
                       style={{ color: 'var(--t-muted)' }}>Links</p>
        ...
        case 'stat':
            return (
                <div className="h-full flex flex-col justify-center overflow-hidden">
                    <div className="font-semibold leading-none tracking-tighter"
                         style={{ fontSize: 'clamp(2rem, 3.5vw, 3.5rem)', color: 'var(--t-accent)' }}>
                        {widget.number}
                    </div>
                    <div className="text-[11px] mt-2" style={{ color: 'var(--t-muted)' }}>{widget.label}</div>
                </div>
            );
        ...
        case 'quote':
            return (
                <div className="h-full flex flex-col justify-center overflow-hidden">
                    ...
                    <p className="text-[13px] leading-relaxed italic line-clamp-4"
                       style={{ color: 'rgba(240,239,238,0.8)' }}>{widget.text}</p>
                </div>
            );
        ...
        case 'location':
            return (
                <div className="h-full flex flex-col justify-end overflow-hidden"
                    ...
                    <div className="text-[11px] mt-0.5 truncate" style={{ color: 'var(--t-muted)' }}>{widget.available}</div>
                </div>
            );
